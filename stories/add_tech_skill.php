...
if(isset($_POST['submit'])){
   ...
   $message[] = 'New Technical Skill added!';  
...
<head>
   ...
   <title>Add Technical Skills</title>
...
<section class="playlist-form">
   ...
   <h1 class="heading">When your technical skill saved the day...</h1>

   <form action="" method="post" enctype="multipart/form-data">
      <p>Story title <span>*</span></p>
      <input type="text" name="title" value="Technical Skills saved the day" class="box" readonly>

      <select hidden name="status" class="box" required>
         <option value="Technical Skill" selected>Technical skill</option>
      </select>
      <!-- <p>Title <span>*</span></p>
      ...
      <p>What technical skill did you learn/use/improve? What were the final <b style="color: black;">R</b>esults? Include factual information such as numbers or quotes from stakeholders. Be clear about the before and after changes.
