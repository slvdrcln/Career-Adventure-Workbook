...
if(isset($_POST['submit'])){
   ...
   $message[] = 'New Lesson Learned added!';  
...
<head>
   ...
   <title>Add Lesson Learned</title>
...
<section class="playlist-form">
   ...
   <h1 class="heading">What are the two most important lessons learned during your career thus far?</h1>

   <form action="" method="post" enctype="multipart/form-data">
      <p>Story Title <span>*</span></p>
      <input type="text" name="title" value="Lesson Learned" class="box" readonly>
      
      <select hidden name="status" class="box" required>
         <option value="Lesson Learned" selected>Lesson Learned</option>
      </select>
      <br> <br>
      <!-- <p>Title <span>*</span></p>
      ...
      <p>What did you learn? What were the final <b style="color: black;">R</b>esults? Include factual information such as numbers or quotes from stakeholders. Be clear about the before and after changes.
