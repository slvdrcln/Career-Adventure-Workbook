...
<section class="playlist-form">
   ...
   <h1 class="heading">What are your greatest career accomplishments?</h1>

   <form action="" method="post" enctype="multipart/form-data">
      <p>Story title</p>
      <!-- <select name="title" class="box" required>
         <option value="Greatest Accomplishment" selected>Greatest Accomplishment</option>
      </select> -->
      <input type="text" name="title" value="Greatest Accomplishment" class="box" readonly>
      <select hidden name="status" class="box" required>
         <option value="Accomplishment" selected>Accomplishment</option>
      </select>
      

      <!-- <p>Story Title</p>
      <p name="title" style="font-size: 2.3rem; color: #2c3e50; margin-top:0;"><b>Your greatest accomplishment</b></p> -->
      <br>
      <br>
      
      <p>What was the <b style="color: black;">S</b>ituation? Who, what, why, how, when, where, and to what degree? <span>*</span> <span class="info"><i class="fa-sharp fa-solid fa-circle-info"></i> <span class="extra-info">
      ...
      <p>What ended up happening? What were the final <b style="color: black;">R</b>esults? Include factual information such as numbers or quotes from stakeholders. Be clear about the before and after changes.
