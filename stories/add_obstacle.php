...
<section class="playlist-form">
   ...
   <h1 class="heading">What are the largest obstacles that you ever faced in your career?</h1>

   <form action="" method="post" enctype="multipart/form-data">
      <p>Story Title <span>*</span></p>
      <input type="text" name="title" value="Greatest Obstacle" class="box" readonly>
