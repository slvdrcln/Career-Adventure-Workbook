...
if(isset($_POST['submit'])){
   ...
   $message[] = 'New Interpersonal Skill added!';  
...
<head>
   ...
   <title>Add Interpersonal skill</title>
...
<section class="playlist-form">
   ...
   <h1 class="heading">What are your two to three greatest interpersonal skills?</h1>

   <form action="" method="post" enctype="multipart/form-data">
      <p>Story title <span>*</span></p>
      <input type="text" name="title" value="Most difficult customer/boss you faced" class="box" readonly>

      <select hidden name="status" class="box" required>
         <option value="Interpersonal Skill" selected>Interpersonal Skill</option>
      </select>
      <br> <br>
      <!-- <p>Title <span>*</span></p>
      ...
      <p>What soft skill did you learn/use/improve? What were the final <b style="color: black;">R</b>esults? Include factual information such as numbers or quotes from stakeholders. Be clear about the before and after changes.
