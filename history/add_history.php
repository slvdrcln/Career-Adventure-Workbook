...
if(isset($_POST['submit'])){
   ...
   $add_history = $conn->prepare("INSERT INTO `history`(id, user_id, org_name, org_add, org_phone, org_web, job_title, start_date, end_date, base_pay, annual_comp, boss_name, boss_job_title, boss_phone, boss_email, ref_name, ref_job_title, ref_phone, ref_email, main_task, imp_task_one, imp_task_two, imp_task_three, imp_task_four, imp_task_five, imp_task_six, imp_task_seven, imp_task_eight, imp_task_nine, imp_task_ten, scope_of_role, pos_summary, pos_headline) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
   $add_history->execute([$id, $user_id, $org_name, $org_add, $org_phone, $org_web, $job_title, $start_date, $end_date, $base_pay, $annual_comp, $boss_name, $boss_job_title, $boss_phone, $boss_email, $ref_name, $ref_job_title, $ref_phone, $ref_email, $main_task, $imp_task_one, $imp_task_two, $imp_task_three, $imp_task_four, $imp_task_five, $imp_task_six, $imp_task_seven, $imp_task_eight, $imp_task_nine, $imp_task_ten, $scope_of_role, $pos_summary, $pos_headline]);
...
<section class="playlist-form">
   ...
   <h1 class="heading">Complete the following fields for every job you have held and every volunteer position:</h1>

   <form action="" method="post" enctype="multipart/form-data">
      
      <br>
      <p>Organization name:<span>*</span></p>
      <input type="text" name="org_name" maxlength="100" placeholder="" class="box" required>

      <p>Organization address:<span>*</span></p>
      <input type="text" name="org_add" maxlength="100" placeholder="" class="box" required>


      <p>Organization phone:<span>*</span></p>
      <input type="text" name="org_phone" maxlength="100" placeholder="" class="box" required>

      <p>Organization website:</p>
      <input type="text" name="org_web" maxlength="100" placeholder="" class="box">

      <p>Actual job title:<span>*</span></p>
      <input type="text" name="job_title" maxlength="100" placeholder="" class="box" required>
      ...
      <p>End date:<span>*</span><span class="info"><i class="fa-sharp fa-solid fa-circle-info"></i> <span class="extra-info">
        if this is your current job, type "present" in this field</span></i></span></p>
      <input type="text" name="end_date" maxlength="100" placeholder="" class="box" required>
      
      <p>Base pay:</p>
      <input type="text" name="base_pay" maxlength="100" placeholder="" class="box">
      <p>Total annual compensation:</p>
      <input type="text" name="annual_comp" maxlength="100" placeholder="" class="box">
      <p>Boss' name:</p>
      <input type="text" name="boss_name" maxlength="100" placeholder="" class="box">
      <p>Boss' actual title:</p>
      <input type="text" name="boss_job_title" maxlength="100" placeholder="" class="box">
      <p>Boss' phone:</p>
      <input type="text" name="boss_phone" maxlength="100" placeholder="" class="box">
      <p>Boss' email:</p>
      <input type="text" name="boss_email" maxlength="100" placeholder="" class="box">
      <p>Reference's name:</p>
      <input type="text" name="ref_name" maxlength="100" placeholder="" class="box">
      <p>Reference's job title:</p>
      <input type="text" name="ref_job_title" maxlength="100" placeholder="" class="box">
      <p>Reference's personal phone:</p>
      <input type="text" name="ref_phone" maxlength="100" placeholder="" class="box">
      <p>Reference's personal email:</p>
      <input type="text" name="ref_email" maxlength="100" placeholder="" class="box">
      ...
      <textarea name="main_task" class="box" required placeholder="" maxlength="1000" cols="30" rows="10"></textarea>
      <p>Important tasks & results: <span class="info"><i class="fa-sharp fa-solid fa-circle-info"></i> <span class="extra-info">
        for each task add the desired outcomes, your actual outcomes, and links to evidence of those outcomes (e.g. URL to an image showing numbers or quotes)</span></i></span></p>
      <textarea name="imp_task_one" class="box" maxlength="1000" cols="30" rows="10"></textarea>
      <p>Important tasks & results: <span class="info"><i class="fa-sharp fa-solid fa-circle-info"></i> <span class="extra-info">
        for each task add the desired outcomes, your actual outcomes, and links to evidence of those outcomes (e.g. URL to an image showing numbers or quotes)</span></i></span></p>
      <textarea name="imp_task_two" class="box" maxlength="1000" cols="30" rows="10"></textarea>
      <p>Important tasks & results: <span class="info"><i class="fa-sharp fa-solid fa-circle-info"></i> <span class="extra-info">
        for each task add the desired outcomes, your actual outcomes, and links to evidence of those outcomes (e.g. URL to an image showing numbers or quotes)</span></i></span></p>
      <textarea name="imp_task_three" class="box" maxlength="1000" cols="30" rows="10"></textarea>
      <p>Important tasks & results: <span class="info"><i class="fa-sharp fa-solid fa-circle-info"></i> <span class="extra-info">
        for each task add the desired outcomes, your actual outcomes, and links to evidence of those outcomes (e.g. URL to an image showing numbers or quotes)</span></i></span></p>
      <textarea name="imp_task_four" class="box" maxlength="1000" cols="30" rows="10"></textarea>
      <p>Important tasks & results: <span class="info"><i class="fa-sharp fa-solid fa-circle-info"></i> <span class="extra-info">
        for each task add the desired outcomes, your actual outcomes, and links to evidence of those outcomes (e.g. URL to an image showing numbers or quotes)</span></i></span></p>
      <textarea name="imp_task_five" class="box" maxlength="1000" cols="30" rows="10"></textarea>
      <p>Important tasks & results: <span class="info"><i class="fa-sharp fa-solid fa-circle-info"></i> <span class="extra-info">
        for each task add the desired outcomes, your actual outcomes, and links to evidence of those outcomes (e.g. URL to an image showing numbers or quotes)</span></i></span></p>
      <textarea name="imp_task_six" class="box" maxlength="1000" cols="30" rows="10"></textarea>
      <p>Important tasks & results: <span class="info"><i class="fa-sharp fa-solid fa-circle-info"></i> <span class="extra-info">
        for each task add the desired outcomes, your actual outcomes, and links to evidence of those outcomes (e.g. URL to an image showing numbers or quotes)</span></i></span></p>
      <textarea name="imp_task_seven" class="box" maxlength="1000" cols="30" rows="10"></textarea>
      <p>Important tasks & results: <span class="info"><i class="fa-sharp fa-solid fa-circle-info"></i> <span class="extra-info">
        for each task add the desired outcomes, your actual outcomes, and links to evidence of those outcomes (e.g. URL to an image showing numbers or quotes)</span></i></span></p>
      <textarea name="imp_task_eight" class="box" maxlength="1000" cols="30" rows="10"></textarea>
      <p>Important tasks & results: <span class="info"><i class="fa-sharp fa-solid fa-circle-info"></i> <span class="extra-info">
        for each task add the desired outcomes, your actual outcomes, and links to evidence of those outcomes (e.g. URL to an image showing numbers or quotes)</span></i></span></p>
      <textarea name="imp_task_nine" class="box" maxlength="1000" cols="30" rows="10"></textarea>
      <p>Important tasks & results: <span class="info"><i class="fa-sharp fa-solid fa-circle-info"></i> <span class="extra-info">
        for each task add the desired outcomes, your actual outcomes, and links to evidence of those outcomes (e.g. URL to an image showing numbers or quotes)</span></i></span></p>
      <textarea name="imp_task_ten" class="box" maxlength="1000" cols="30" rows="10"></textarea>
      <p>Scope of role:<span>*</span><span class="info"><i class="fa-sharp fa-solid fa-circle-info"></i> <span class="extra-info">
        total budget managed, # of direct reports and employees in your food chain, decision authority, accountabilities, major requirements</span></i></span></p>
      <input type="text" name="scope_of_role" required maxlength="100" placeholder="" class="box">
      ...
      <textarea name="pos_summary" class="box" required maxlength="1000" cols="30" rows="10"></textarea>
      ...
      <input type="text" name="pos_headline" required maxlength="100" class="box">


      <input type="submit" value="Create history" name="submit" class="btn">
   </form>
