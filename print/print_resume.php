     ...
     while($fetch_educ = $select_educ->fetch(PDO::FETCH_ASSOC)){
      ...
      ?>
        ...
        while($fetch_skills = $select_skills->fetch(PDO::FETCH_ASSOC)){
          ...
          <ul class="language">
            <li>
             <span class="text"><?php echo $fetch_skills['language_one']; ?>, <?php echo $fetch_skills['prof_lang_one']; ?></span>
            <!--   <span class="percent">
		...
		<div style="width: <?php echo $fetch_skills['prof_lang_one']; ?>%;"></div>
            ...
            <li>
             <span class="text"><?php echo $fetch_skills['language_two']; ?>, <?php echo $fetch_skills['prof_lang_two']; ?></span>
            <!--   <span class="percent">
                <div style="width: 95%"></div>
              </span> -->
            </li>
            <li>
              <span class="text"><?php echo $fetch_skills['language_three']; ?>, <?php echo $fetch_skills['prof_lang_three']; ?></span>
              <!-- <span class="percent">
