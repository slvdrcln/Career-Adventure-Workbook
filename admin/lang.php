...
<section id="skills" class="playlists">
   ...
   <?php
      $select_skills = $conn->prepare("SELECT * FROM `languages` WHERE user_id = ? ORDER BY date DESC");
...
$i=1;
foreach($fetch_skills as $key => $row) {
      ?>
      <div class="box">
         <div class="flex">
         <div hidden><?= $i++;?></div>
         ...
         <p class="description"><?php echo $row['languages'];?></p>
