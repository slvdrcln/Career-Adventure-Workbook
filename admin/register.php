   ...
   <div class="forms-container">
      ...
      <div class="signin-signup">
          ...
          <form action="#" class="sign-up-form" method="post" enctype="multipart/form-data">
            ...
            <div class="input-field"><i class="fas fa-lock"></i><input type="password" name="pass" placeholder="Password" required/></div>
            <div class="input-field"><i class="fas fa-lock"></i><input type="password" name="cpass" placeholder="Confirm password" required/></div>
