...
$pref_place_five = $_POST['pref_place_five'];
   ...
   $add_preference = $conn->prepare("INSERT INTO `preference`(id, user_id, title, pref_place_one, pref_place_two, pref_place_three, pref_place_four, pref_place_five, days, hours) VALUES(?,?,?,?,?,?,?,?,?,?)");
   $add_preference->execute([$id, $user_id, $title, $pref_place_one, $pref_place_two, $pref_place_three, $pref_place_four, $pref_place_five, $days, $hours]);

   $message[] = 'New preferences added!';  
}
...
<h1 class="heading">Preferred working hours & days</h1>

<form action="" method="post" enctype="multipart/form-data">
   <select name="title" class="box" hidden required>
   ...
   <input type="text" name="pref_place_one" class="box">
<input type="text" name="pref_place_two" class="box">
<input type="text" name="pref_place_three" class="box">
<input type="text" name="pref_place_four" class="box">
<input type="text" name="pref_place_five" class="box">
   <p>Preferred working days:</p>      
   <input type="text" name="days" class="box">


   <p>Preferred working hours:</p>
   <input type="text" name="hours" class="box">



   <input type="submit" value="Create" name="add_pref" class="btn">
</form>
