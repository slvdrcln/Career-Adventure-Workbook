...
if(isset($_POST['submit'])){
  ...
  $update_skills = $conn->prepare("UPDATE `skills` SET language_one = ?, prof_lang_one = ?, language_two = ?, prof_lang_two = ?, language_three = ?, prof_lang_three = ?, skill_one = ?, skill_two = ?, skill_three = ?, skill_four = ?, skill_five = ?, skill_six = ?, skill_seven = ?, skill_eight = ?, skill_nine = ?, skill_ten = ?, skill_eleven = ?, skill_twelve = ?, skill_thirteen = ?, skill_fourteen = ?, skill_fifteen = ?, skill_sixteen = ?, skill_seventeen = ?, skill_eighteen = ?, skill_nineteen = ?, skill_twenty = ? WHERE id = ?");
  $update_skills->execute([$language_one, $prof_lang_one, $language_two, $prof_lang_two, $language_three, $prof_lang_three, $skill_one, $skill_two, $skill_three, $skill_four, $skill_five, $skill_six, $skill_seven, $skill_eight, $skill_nine, $skill_ten, $skill_eleven, $skill_twelve, $skill_thirteen, $skill_fourteen, $skill_fifteen, $skill_sixteen, $skill_seventeen, $skill_eighteen, $skill_nineteen, $skill_twenty, $get_id]);$message[] = 'Skills updated!';  
}
...
<?php
         $select_skills = $conn->prepare("SELECT * FROM `skills` WHERE id = ?");
         $select_skills->execute([$get_id]);
...
<option value="<?= $fetch_skills['language_one']; ?>" selected><?= $fetch_skills['language_one']; ?></option>
    ...
    <option value="<?= $fetch_skills['prof_lang_one']; ?>" selected><?= $fetch_skills['prof_lang_one']; ?></option>
...
<option value="<?= $fetch_skills['language_two']; ?>" selected><?= $fetch_skills['language_two']; ?></option>
          <option value="Mandarin">Chinese, Mandarin</option>
          <option value="Spanish">Spanish</option>
          <option value="English">English</option>           
          <option value="Bengali">Bengali</option>
    ...
    <option value="<?= $fetch_skills['prof_lang_two']; ?>" selected><?= $fetch_skills['prof_lang_two']; ?></option>
		<option value="Native fluency">Native fluency</option>
		<option value="Educational fluency">Educational fluency</option>
		<option value="Intermediate proficiency">Intermediate proficiency</option>
		<option value="Basic proficiency">Basic proficiency</option>
...
<option value="<?= $fetch_skills['language_three']; ?>" selected><?= $fetch_skills['language_three']; ?></option>
          <option value="Mandarin">Chinese, Mandarin</option>
          <option value="Spanish">Spanish</option>
          <option value="English">English</option>           
          <option value="Bengali">Bengali</option>
    ...
    <option value="<?= $fetch_skills['prof_lang_three']; ?>" selected><?= $fetch_skills['prof_lang_three']; ?></option>
		<option value="Native fluency">Native fluency</option>
		<option value="Educational fluency">Educational fluency</option>
		<option value="Intermediate proficiency">Intermediate proficiency</option>
		<option value="Basic proficiency">Basic proficiency</option>
    ...
    <br>
      ...
      <p>Skills: <span class="info"><i class="fa-sharp fa-solid fa-circle-info"></i> <span class="extra-info">
        add at least ten (10) skills that are not listed in other sections</span></i></span></p>
      <input type="text" name="skill_one" maxlength="100" placeholder="" class="box" required value="<?= $fetch_skills['skill_one']; ?>">
      <input type="text" name="skill_two" maxlength="100" placeholder="" class="box" value="<?= $fetch_skills['skill_two']; ?>">
      <input type="text" name="skill_three" maxlength="100" placeholder="" class="box" value="<?= $fetch_skills['skill_three']; ?>">
      <input type="text" name="skill_four" maxlength="100" placeholder="" class="box" value="<?= $fetch_skills['skill_four']; ?>">
      <input type="text" name="skill_five" maxlength="100" placeholder="" class="box" value="<?= $fetch_skills['skill_five']; ?>">
      <input type="text" name="skill_six" maxlength="100" placeholder="" class="box" value="<?= $fetch_skills['skill_six']; ?>">
      <input type="text" name="skill_seven" maxlength="100" placeholder="" class="box" value="<?= $fetch_skills['skill_seven']; ?>">
      <input type="text" name="skill_eight" maxlength="100" placeholder="" class="box" value="<?= $fetch_skills['skill_eight']; ?>">
      <input type="text" name="skill_nine" maxlength="100" placeholder="" class="box" value="<?= $fetch_skills['skill_nine']; ?>">
      <input type="text" name="skill_ten" maxlength="100" placeholder="" class="box" value="<?= $fetch_skills['skill_ten']; ?>">
<input type="text" name="skill_eleven" maxlength="100" placeholder="" class="box" value="<?= $fetch_skills['skill_eleven']; ?>">
  <input type="text" name="skill_twelve" maxlength="100" placeholder="" class="box" value="<?= $fetch_skills['skill_twelve']; ?>">
  <input type="text" name="skill_thirteen" maxlength="100" placeholder="" class="box" value="<?= $fetch_skills['skill_thirteen']; ?>">
  <input type="text" name="skill_fourteen" maxlength="100" placeholder="" class="box" value="<?= $fetch_skills['skill_fourteen']; ?>">
  <input type="text" name="skill_fifteen" maxlength="100" placeholder="" class="box" value="<?= $fetch_skills['skill_fifteen']; ?>">
  <input type="text" name="skill_sixteen" maxlength="100" placeholder="" class="box" value="<?= $fetch_skills['skill_sixteen']; ?>">
  <input type="text" name="skill_seventeen" maxlength="100" placeholder="" class="box" value="<?= $fetch_skills['skill_seventeen']; ?>">
  <input type="text" name="skill_eighteen" maxlength="100" placeholder="" class="box" value="<?= $fetch_skills['skill_eighteen']; ?>">
  <input type="text" name="skill_nineteen" maxlength="100" placeholder="" class="box" value="<?= $fetch_skills['skill_nineteen']; ?>">
  <input type="text" name="skill_twenty" maxlength="100" placeholder="" class="box" value="<?= $fetch_skills['skill_twenty']; ?>">
